        ...
        <>
            <main className="grid place-content-center min-h-screen bg-gradient-to-t from-purple-400">
                ...
                <header className="text-center text-slate-800 font-bold text-2xl">
                    ...
                    <div className="text-xs m-3 text-center">Don't have an account? Create a <a className="text-purple-800" href="http://localhost:3000/auth/register">new account.</a></div>
                </div>
            </main>
        </>
    )
